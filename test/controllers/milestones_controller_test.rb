...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference("Milestone.count") do
      post milestones_url, params: { milestone: { contract_id_id: @milestone.contract_id_id, date: @milestone.date, name: @milestone.name, status: @milestone.status } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { contract_id_id: @milestone.contract_id_id, date: @milestone.date, name: @milestone.name, status: @milestone.status } }
