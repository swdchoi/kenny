...
class PaymentTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_term" do
    assert_difference("PaymentTerm.count") do
      post payment_terms_url, params: { payment_term: { amount: @payment_term.amount, completed_date: @payment_term.completed_date, contract_id_id: @payment_term.contract_id_id, description: @payment_term.description, percentage: @payment_term.percentage, status: @payment_term.status, target_date: @payment_term.target_date } }
    end
  ...
  test "should update payment_term" do
    patch payment_term_url(@payment_term), params: { payment_term: { amount: @payment_term.amount, completed_date: @payment_term.completed_date, contract_id_id: @payment_term.contract_id_id, description: @payment_term.description, percentage: @payment_term.percentage, status: @payment_term.status, target_date: @payment_term.target_date } }
